...
public class Thirdframe extends JFrame implements ActionListener{
	...
	public Thirdframe(String user_name){
		this.user_name=user_name;
		setLayout(null);
		setSize(400,400);
		label4=new JLabel("Add Conact");
		label4.setFont(new Font("Tempus Sans ITC",Font.BOLD,20));
		label4.setBounds(140, 5, 150, 25);
		add(label4);
		label1=new JLabel(new ImageIcon("image13.png"));
		...
		tf2.setBounds(140,245,200,25);
		add(tf2);
		button1=new JButton("Add");
		button1.setFont(new Font("Brush Script MT",Font.BOLD,20));
		button1.setBounds(260,280,80,30);
	...
	public void actionPerformed(ActionEvent e){
		if(e.getSource()==button1){
			...
			Integer contact_number=Integer.valueOf(tf2.getText());
			tf1.setText("");
			tf2.setText("");
